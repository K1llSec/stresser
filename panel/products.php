						...
						<div class="table-responsive">
							...
							<table class="table table-striped table-vcenter">
								...
								while ($getInfo = $SQLGetPlans -> fetch(PDO::FETCH_ASSOC)){
								    ...
								    if($bitcoin == 1){ $BitcoinAccepted = '<a href="purchase/buy_plan.php?id='.$ID.'"><img src="assets/img/favicons/bitcoin.png" style="width: 12px;"></a> <a href="skrill.php?id='.$ID.'"><img src="assets/img/favicons/skrill.png" style="width: 17px;"></a>'; } else { $BitcoinAccepted = ''; }

									if($paypal == 1){ $PayPalAccepted = '<a href="purchase/buy_plan.php?id='.$ID.'"><img src="assets/img/favicons/paypal.jpg" style="width: 17px;"></a>'; } else { $PayPalAccepted = ''; }
