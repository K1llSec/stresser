    ...
    <body class="">
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed side-overlay-o">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white" href="/panel/home.php">
                                ...
                                <i class="si si-<?php echo htmlentities($logo); ?> text-primary"></i> <span class="h4 font-w600 sidebar-mini-hide">CyanideStresser</span>
						...
						<li>
                                    ...
                                    <a href="dstat.php" <?php if (basename($_SERVER['PHP_SELF']) == "dstat.php") { ?> class="active" <?php } ?>><i class="si si-layers"></i><span class="sidebar-mini-hide">DSTAT</span></a>
			...
			<?php
				...
				<li>
					<div class="btn-group">
						<a href="https://twitter.com/CyanideSupport" target="_blank">
